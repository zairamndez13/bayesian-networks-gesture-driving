...
modelo <- function() {
  ...
  # Priors 
  beta0_f ~ dnorm(5, 0.01)
  beta0_c ~ dnorm(5, 0.01); beta3_c ~ dnorm(0, 0.01)
  beta0_s ~ dnorm(5, 0.01); beta3_s ~ dnorm(0, 0.01)
  beta0_l ~ dnorm(5, 0.01); beta3_l ~ dnorm(0, 0.01)
  beta0_p ~ dnorm(5, 0.01); beta3_p ~ dnorm(0, 0.01)
